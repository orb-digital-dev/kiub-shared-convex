...
export default defineSchema(
    {
        ...
        subscriptions: defineTable({
            ...
            payment_plans: v.optional(v.array(v.object({
                plan_type: v.string(),
                durationInDays: v.string(),
                durationPerMonth: v.string(),
            }))),
            durationInDays: v.string(),
            ...
            description: v.object({
                ...
                calendarAccountMax: v.string(),
                gmailAccountMax: v.string(),
                trelloAccountMax: v.string(),
                githubAccountMax: v.string(),
                jiraAccountMax: v.string(),
                notionAccountMax: v.string(),
                slackAccountMax: v.string(),
                todoistAccountMax: v.string(),
                asanaAccountMax: v.string(),
                clickupAccountMax: v.string(),
            })
        }),
